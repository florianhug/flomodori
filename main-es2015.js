...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- shamelessly copied from https://github.com/tiagobalmeida/purecss-circular-progress-bar -->\n\n<div class=\"progress-circle p{{percentage$ | async}}\"\n     [ngClass]=\"{'over50' : (percentage$ | async)>50}\">\n  <span>{{currentSeconds$ | async | timeformat}}</span>\n  <div class=\"left-half-clipper\">\n    <div class=\"first50-bar\"></div>\n    <div class=\"value-bar\"></div>\n  </div>\n</div>\n");
...
/* harmony import */ var _flomodori_flomodory_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./flomodori/flomodory.component */ "./src/app/flomodori/flomodory.component.ts");




const routes = [
    { path: '', component: _flomodori_flomodory_component__WEBPACK_IMPORTED_MODULE_3__["FlomodoryComponent"] }
];
...
/* harmony import */ var _flomodori_flomodory_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./flomodori/flomodory.component */ "./src/app/flomodori/flomodory.component.ts");
/* harmony import */ var _timeformat_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./timeformat.pipe */ "./src/app/timeformat.pipe.ts");
/* harmony import */ var _progress_progress_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./progress/progress.component */ "./src/app/progress/progress.component.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _flomodori_flomodory_component__WEBPACK_IMPORTED_MODULE_7__["FlomodoryComponent"],
            _timeformat_pipe__WEBPACK_IMPORTED_MODULE_8__["TimeformatPipe"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FlomodoryComponent", function() { return FlomodoryComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let FlomodoryComponent = FlomodoryComponent_1 = class FlomodoryComponent {
    constructor() {
    ...
    startTimer() {
        ...
        this.timer$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, 1000)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => FlomodoryComponent_1.DEFAULT_TIMER - value), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(value => value >= 0))
            .subscribe(value => this._timerValue$.next(value), error => console.log(error), () => {
            this._timerValue$.next(FlomodoryComponent_1.DEFAULT_TIMER);
...
FlomodoryComponent = FlomodoryComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-flomodory',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./flomodory.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/flomodori/flomodory.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./flomodory.component.scss */ "./src/app/flomodori/flomodory.component.scss")).default]
    })
], FlomodoryComponent);
...
let ProgressComponent = class ProgressComponent {
    ...
    ngOnInit() {
        this.percentage$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.totalSeconds$, this.currentSeconds$)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(([total, current]) => (total - current) / total), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => value * 100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => Math.ceil(value)));
        this.percentage$.subscribe(value => console.log(`Value: ${value}`));
    }
};
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ProgressComponent.prototype, "totalSeconds$", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ProgressComponent.prototype, "currentSeconds$", void 0);
ProgressComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-progress',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./progress.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/progress/progress.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./progress.component.scss */ "./src/app/progress/progress.component.scss")).default]
    })
], ProgressComponent);
...
module.exports = __webpack_require__(/*! /home/runner/work/flomodori/flomodori/src/main.ts */"./src/main.ts");
